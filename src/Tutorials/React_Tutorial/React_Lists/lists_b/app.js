...
- Keys need to be unique to eacg sibling. But they can be duplicated globally.
- N/B: Generally, the key should be a unique ID assigned to each item. As a last resort, you can use
