...
- If you find yourself keeping track of multiple pieces of state that rely on complex logix, useReducer
  may be useful.

--- Syntax
- The useReducer Hook accepts two arguments
- useReducer(<reducer>, <initialState>)
- The reudcer function contains your custom state logic and the initialState can be a simple value but
